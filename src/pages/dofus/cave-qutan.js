...
<div className={styles.blogContainer}>
  <div className={styles.main}>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox}>
      <p>Chers aventuriers du Monde des Douze, je saisis aujourd’hui ma plume de tofu pour vous parler un peu de l’avenir de DOFUS Retro. En effet, en décembre dernier, nous vous avions présenté lors d’un live le contenu de la nouvelle mise à jour qui se ponctuait d’une annonce un peu spéciale : nous avons abordé le sujet d’une potentielle mise à jour qui introduirait une nouvelle zone qui contient des maps farmables au niveau de l'entrée du donjon Qu'Tan. À la suite de ce live haut en émotions, nous vous avions sondé afin de jauger votre réception : l’énorme majorité était positive à cette direction et c’est ainsi qu’aujourd’hui, nous vous présentons enfin un peu plus en détail cette mise à jour sobrement appelée : " La maj Qu'Tan ".</p>
      <br />
      <p>Asseyez-vous, prenez un café ou un thé et c’est parti !</p>
      <br />
      <div className={styles.blogImg}>
      <Image src="/assets/qutann.jpg" layout='fill'/>
      </div>
      <p>Cette nouvelle sous-zone vous permettera de farmer les ressources nécessaires pour le craft des items Qu'Tan plus facilement et plus rapidement.</p>
      <p>Cette nouvelle cave proposera :</p>
      <br />
      <p className={styles.boldText}>Une nouvelle famille de monstres</p><br />
      <p className={styles.boldText}>De nouvelles cartes à explorer</p><br />
      <p className={styles.boldText}>Et aussi plein d'autre surprises !</p><br />
      <p className={styles.boldText}>Pour accéder à la cave il suffit de débloquer l'accès.</p>
