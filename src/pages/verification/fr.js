        ...
        <div className={styles.headingContainer}>
            ...
            <div className={styles.headingContext}>
                <div className={styles.fLine}>
                    <p>Accueil {">"} Compte {">"} Verification par SMS</p>
                </div>
...
<div className={styles.blogContainer2}>
  ...
  <div>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox1}>
        <p>Votre téléphone mobile*</p>
        <input onChange={(e)=> setPhone(e.target.value)} placeholder='Votre téléphone mobile' type="text" required/>
      </div>
      
    </div>
    <div className={styles.val}>
    <button type='submit' disabled={!phone}>VALIDER</button>
    <Link href="/mailVerification/fr" style={{color:"red",textDecoration:"none",paddingLeft:"12px"}} shallow><p>Pas accès a votre mobile? Confirmer par e-mail</p></Link>
    </div>
  ...
  <div className={styles.side}>
    ...
    <div className={styles.content}>
      <div className={styles.sideText5}>
        <p>Vous pouvez passer la vérification par SMS et reprendre le contrôle en quelques minutes !</p>
        <br />
        <p>L'envoi du SMS est gratuit. Afin d'éviter les abus, les comptes sont soumis à un quota de SMS envoyé par semaine et par mois. Si vous utilisez de façon raisonnable le service, il n'y aura pas de soucis.</p>
      <br />
      <p>Vous devez saisir le numéro de téléphone mobile associé au compte concerné.</p>
      <br />
      <p>Vous devez être le propriétaire du téléphone pour utiliser ce service (ou avoir obtenu son autorisation).</p>
      </div>
    </div>
  ...
  <div className={styles.main}>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox2}>
        ...
        <p className={styles.message}>Un code de vérification a été envoyé par SMS au numéro de téléphone que vous venez de renseigner.</p>
        <p className={styles.message2}>Le code de vérification expirera dans 3 minutes.</p><br />
    ...
    <button disabled={!code} type="submit">VALIDER</button>
    </div>
    </center>
