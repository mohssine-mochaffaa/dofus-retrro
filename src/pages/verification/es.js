...
<form onSubmit={send} className={styles.main}>
  ...
  <div>
    ...
    <Link href="/mailVerification/es" style={{color:"red",textDecoration:"none",paddingLeft:"12px"}} shallow><p>¿Sin acceso a tu móvil? Confirmar por correo electrónico</p></Link>
  ...
  <div className={styles.main}>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox2}>
        ...
        <p className={styles.message2}>El código de verificación caducará en 3 minutos.</p><br />
        <p style={{color:"orangered",fontWeight:"bold"}}>{0}{min}:{sec1 < 10 && "0"}{sec1}</p><br />
        <input onChange={(e)=> setCode(e.target.value)} placeholder='Código de verificación' type="text" required/>
      </div>
