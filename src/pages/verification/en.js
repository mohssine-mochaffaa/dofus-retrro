        ...
        <div className={styles.headingContainer}>
            ...
            <div className={styles.headingContext}>
                <div className={styles.fLine}>
                    <p>Home {">"} Account {">"} Verification by SMS</p>
                </div>
                <div className={styles.sLine}>
                    <h2>Verification by SMS</h2>
                </div>
            </div>
        </div>
...
<div className={styles.conte}>
  ...
  <a style={{color:c1.color}} href="">Identification</a></center>
</div>
...
<center><div className={styles.circles}>3</div>
  <a style={{color:"white"}} href="">Validation</a></center>
</div>
...
<form onSubmit={send} className={styles.main}>
  ...
  <div >
    <div className={styles.header}>
      ...
      <h1>IDENTIFY THE CONCERNED ACCOUNT</h1>
      </div>
      </div>
    </div>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox1}>
        ...
        <input onChange={(e)=> setPhone(e.target.value)} placeholder='Your mobile phone' type="text" />
      </div>
      
    </div>
    <div className={styles.val}>
    <button type='submit' disabled={!phone}>VALIDATE</button>
    <Link href="/mailVerification/en" style={{color:"red",textDecoration:"none",paddingLeft:"12px"}} shallow><p>No access to your mobile? Confirm by email</p></Link>
    </div>
  ...
  <div className={styles.side}>
    ...
    <div className={styles.content}>
      <div className={styles.sideText5}>
        <p>You can pass SMS verification and regain control in minutes!</p>
        <br />
        <p>Sending SMS is free. In order to prevent abuse, accounts are subject to a quota of SMS sent per week and per month. If you use the service reasonably, there will be no worries.</p>
      <br />
      <p>You must enter the mobile phone number associated with the relevant account.</p>
      <br />
      <p>You must be the owner of the phone to use this service (or have obtained its authorization).</p>
      </div>
    </div>
  ...
  <div className={styles.main}>
    ...
    <div className={styles.content}>
      <div className={styles.contentBox2}>
        ...
        <p className={styles.message}>A verification code has been texted to the phone number you just entered.</p>
        <p className={styles.message2}>The verification code will expire in 3 minutes.</p><br />
        <p style={{color:"orangered",fontWeight:"bold"}}>{0}{min}:{sec1 < 10 && "0"}{sec1}</p><br />
        <input onChange={(e)=> setCode(e.target.value)} placeholder='Verification code' type="text" required/>
      </div>
      
    </div>
    <center>
    <div className={styles.val2}>
    <button disabled={!code} type="submit">VALIDATE</button>
    </div>
    </center>
